...
Repository Contents:
* TREATEMENT.m: Computes features extracted from the Heart rate curve and Systolic, Diastolic, and Mean Blood Pressure using MATLAB
* TREATEMENT_NIB.m: Computes features extracted from the Heart rate curve and Systolic, Diastolic, and Mean Blood Pressure for Non Invasive Blood Pressure
* PATIENT1.mat & PATIENT2.mat & PATIENT3.mat: Sample data from three patients. Data structure includes:
...
* PATIENT_NIB.mat Sample data from a patient that had a Non Invasive Blood Pressure (PNIs, PNId, PNIm)

The output of TREATEMENT.m (resp. TREATEMENT_NIB.m) provides features computed every 24 hours. Outputs include:
* PATIENTxRESULTS.mat: MATLAB file.
* PATIENTxRESULTS.csv: CSV file without headers.
